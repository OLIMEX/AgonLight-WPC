...
: TONE ( chan wf vol freq dur --- )
    BEGIN
      0	4 SYSVARS!
      23 EMIT 0 EMIT $85 EMIT 4 PICK EMIT 3 PICK EMIT 2 PICK EMIT OVER 2EMIT DUP 2EMIT
...
: PR-CHAR      \ c1 ---
               DUP BL = IF EMIT ELSE 17 EMIT DUP 56 - EMIT 65 + EMIT THEN ;
...
: NORMAL-COLOUR 17 EMIT 15 EMIT 17 EMIT 128 EMIT ;
